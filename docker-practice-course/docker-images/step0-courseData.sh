...
echo 'DOCKER_OPTS="-H unix:///var/run/docker.sock -H tcp://0.0.0.0:2375 -H tcp://0.0.0.0:2345 -H fd:// --bip "172.18.0.1/24" --insecure-registry "registry.test.training.katacoda.com:4567""' >> /etc/default/docker
